...
exports.PosModel = Backbone.Model.extend({
    ...
    models: [
    {
        ...
        // ecube custome field import in POS 
        model:  'res.partner',
        fields: ['name','street','city','state_id','country_id','vat','phone','zip','mobile','email','barcode','write_date','property_account_position_id','membership_no',,'branch'],
